...
import { Button, cn, Label, Slider, useOverlayState } from "@heroui/react";
...
import SettingWallpaperModal from "./setting-wallpaper-modal";

export default function WallpaperSettings() {
  const { t } = useTranslation();

  const settingWallpaperModalOverlayState = useOverlayState();
  ...
  const formik = useFormik({
    ...
    async onSubmit() {
      settingWallpaperModalOverlayState.open();
  ...
  return (
    <>
      <SettingWallpaperModal
        state={settingWallpaperModalOverlayState}
      ></SettingWallpaperModal>
      ...
      <CardWithTitle icon={faImage} title={t("wallpaper")}>
        ...
        >
          ...
          <Button
            fullWidth
            type="submit"
            isPending={saveImageMutation.isPending}
          >
